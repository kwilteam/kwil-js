...
const test = async () => {
    //console.log(await ecclesia.createAccount('brennanjl1', 'Ecclesia1'))
    ...
    //console.log(await ecclesia.createThought('Test post!', '', privateKey, 'brennanjl1', 'ecclesia'))
    ...
    //console.log(await ecclesia.createGroup('ecclesia123', false, 'test group2!', ['tag1', 'tag2'], '', [], '#148FA0', 'brennanjl1', privateKey))
    //console.log(await ecclesia.getGroupData('ecclesia'))
    //console.log(await ecclesia.editGroup('ecclesia', 'Test description private!', true, ['tag1', 'tag2', 'tag3'], '', '', '#148FA0', 'brennanjl1', privateKey))
    ...
    //console.log(await ecclesia.getFeed('brennanjl1'))
