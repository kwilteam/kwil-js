...
export class PayloadBuilderImpl<T extends EnvironmentType> implements PayloadBuilder {
  ...
  /**
   * Specifies the challenge for the transaction. If none is provided, the SDK will retrieve the challenge from the network.
   *
  ...
  /**
   * Specifies the signature for the transaction. Signature is generated by client.
   *
